...
- When stuck, search for the specific problem (e.g. "SKY130 two-stage opamp phase margin compensation")
...
- NEVER declare success without passing ALL validation checks in program.md step 6
- NEVER trust `vp()` for phase margin — compute from complex `v(out)` and unwrap
